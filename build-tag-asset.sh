...
BUILD_PATH="$(pwd)"
MODULE="sas-client"
TOKEN="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@github.com"
...
git push https://$TOKEN/$REPO.git $BRANCH
git push https://$TOKEN/$REPO.git refs/tags/$VERSION

set +e
git push https://$TOKEN/$REPO.git :refs/tags/Development
