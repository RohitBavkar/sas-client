...
# Get release id
GIT_HUB_RELEASE_DETAILS_URL="curl -X GET $GITHUB/$REPO/releases/tags/$VERSION -H 'authorization: token $TOKEN' -H 'cache-control: no-cache' | python3 -c \"import sys, json; print json.load(sys.stdin)['id']\""
